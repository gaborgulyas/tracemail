function Firefox_connector() {
    ...
    this.init = function() {
        this.etv = new ETV( _fc_self );

        gBrowser.addEventListener("hashchange", etv_fc.onHashChange, true);
    }
    ...
    this.visualize = function(id) {
		...
		//set smtp
		this.etv.smtp = 'mail.google.com';

        this.etv.visualize(client.responseText, id);
    },
...
var etv_fc = new Firefox_connector();
